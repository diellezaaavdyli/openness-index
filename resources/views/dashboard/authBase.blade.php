...
<html lang="en">
  <head>
    ...
    <title>Openness Index Database</title>
    <link rel="apple-touch-icon" sizes="57x57" href="assets/favicon/favicon.png">
    <link rel="apple-touch-icon" sizes="60x60" href="assets/favicon/favicon.png">
    ...
    <link rel="apple-touch-icon" sizes="120x120" href="assets/favicon/favicon.png">
    ...
    <link rel="icon" type="image/png" sizes="96x96" href="assets/favicon/favicon.png">
    <link rel="icon" type="image/png" sizes="16x16" href="assets/favicon/favicon.png">
    <link rel="manifest" href="assets/favicon/favicon.json">
