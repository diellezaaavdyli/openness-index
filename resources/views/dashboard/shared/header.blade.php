    ...
    <div class="c-wrapper">
      <header class="c-header c-header-light bg-header c-header-fixed c-header-with-subheader">
        <button class="c-header-toggler c-class-toggler d-lg-none mr-auto" type="button" data-target="#sidebar" data-class="c-sidebar-show"><span class="c-header-toggler-icon"></span></button><a class="c-header-brand d-sm-none" href="#"><img class="c-header-brand" src="{{ url('/assets/brand/kosovo-flag.svg')}}" width="97" height="46" alt="Kosovo Flag"></a>
