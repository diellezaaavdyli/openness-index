...
@section('content')
          ...
          <div id="paginationNumbers_wrapper" class="dataTables_wrapper dt-bootstrap4">
            <div class="row">
              <div class="col-sm-12">
                <table id="paginationNumbers" class="table dataTable home-table" width="100%" 
                role="grid" aria-describedby="paginationNumbers_info" style="width: 100%;">

                <thead>
                  <tr role="row" class="home-tr">
                    <th class="th-sm sorting_asc" tabindex="0" aria-controls="paginationNumbers" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name
                : activate to sort column descending" style="width: 130px;">Name Of Ministry</th>
                <th class="th-sm sorting" tabindex="0" aria-controls="paginationNumbers" rowspan="1" colspan="1" aria-label="Office
                : activate to sort column ascending" style="width: 94px;">Office</th>
                <th class="th-sm sorting" tabindex="0" aria-controls="paginationNumbers" rowspan="1" colspan="1" aria-label="Start date
...
<script type="text/javascript" 
src="https://mdbootstrap.com/api/snippets/static/download/MDB-Pro_4.19.2/js/mdb.min.js">
</script>
<script type="text/javascript" 
